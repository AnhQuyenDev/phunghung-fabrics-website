...
<body class="bg-white">
    ...
    <script type="module">
        ...
        function init3D() {
            ...
            loader.load('{{ asset('') }}sofa_pillow.glb', (gltf) => {
                ...
                applyTexture('sofa', '/{{ asset('images/fabrics/11304.jpg') }}');
                applyTexture('pillow', '/{{ asset('images/fabrics/1315.jpg') }}');
            });
        ...
        function populatePalettes() {
             const paletteItemsHTML = fabricFiles.map(file => {
                const path = `/{{ asset('images/fabrics/${file}') }}`;
        ...
        modeCompareBtn.addEventListener('click', () => {
            ...
            if (!compareState.right.sofaTexture) {
                compareState.right.sofaTexture = '/{{ asset('images/fabrics/3816.jpg') }}';
                compareState.right.pillowTexture = '/{{ asset('images/fabrics/5401.jpg') }}';
            }
