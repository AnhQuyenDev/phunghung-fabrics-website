...
document.addEventListener("DOMContentLoaded", () => {
  const swiper = new Swiper(".fabricSwiper", {
    loop: true,
    autoplay: {
      delay: 4000,
    ...
    pagination: {
      el: ".fabricSwiper .swiper-pagination",
      clickable: true,
    },
    navigation: {
      nextEl: ".fabricSwiper .swiper-button-next",
      prevEl: ".fabricSwiper .swiper-button-prev",
    },
  });
...
function asset(path) {
    // Loại bỏ 'public/' nếu có, và nối với assetBaseUrl từ Blade
    return (window.assetBaseUrl ? window.assetBaseUrl : '/') + path.replace(/^\/+|^public\//, '');
}
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const blogPosts = [
        {
            id: 1,
            imageUrl: asset('images/Outdura_ Blog/imgi_3_csm_Coast2Coast_Presentation_Loop_cdb097202a.png'),
            date: 'APR 2025',
        ...
        {
            id: 2,
            imageUrl: asset('images/Outdura_ Blog/imgi_4_csm_IMG_2698_d7775321de.png'),
            date: 'APR 2025',
        ...
        {
            id: 3,
            imageUrl: asset('images/Outdura_ Blog/imgi_5_csm_Wyzenbeek_ff8ab835c7.png'),
            date: 'MAR 2025',
        ...
        {
            id: 4,
            imageUrl: asset('images/Outdura_ Blog/imgi_6_csm_SST-Rumor_Aquatic_6663_11_6eb6b8779c.png'),
            date: 'MAR 2025',
        ...
        {
            id: 5,
            imageUrl: asset('images/Outdura_ Blog/imgi_7_csm_GettyImages-1384259577_85cca33acf.png'),
            date: 'FEB 2025',
        ...
        {
            id: 6,
            imageUrl: asset('images/Outdura_ Blog/imgi_8_csm_Factory_All_Video.01_11_40_23.Still101_ac16d90ed0.png'),
            date: 'JAN 2025',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const stainData = {
        'TEXGARD® Cleaner & TEXGARD® Protector': {
            videoUrl: asset('videos/Outdura_Cleaning-Care_Parasol.mp4'),
            cleaningSteps: [
        ...
        'Beer': {
            videoUrl: asset('videos/Beer_small720p.mp4'),
            cleaningSteps: [
        ...
        'Coca-Cola': {
            videoUrl: asset('videos/Coca-Cola_small720p.mp4'),
            cleaningSteps: [
        ...
        'Chocolate': {
            videoUrl: asset('videos/Cleaning_Chocolate.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Coffee': {
            videoUrl: asset('videos/Coffee_small720p.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Ice cream': {
            videoUrl: asset('videos/Cleaning_Ice_Cream.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Ketchup': {
            videoUrl: asset('videos/Ketchup_small720p.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Milk': {
            videoUrl: asset('videos/Milk_small720p.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Mud': {
            videoUrl: asset('videos/Cleaning_Mud.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Mustard': {
            videoUrl: asset('videos/Cleaning_Mustard.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Orange Juice': {
            videoUrl: asset('videos/Orange_Juice_small720p.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Pen': {
            videoUrl: asset('videos/Cleaning_Pen.mp4'),
            cleaningSteps: [
                'Act quickly, blot the spill.', 'Apply a solution of water and white vinegar.',
                'Blot again with a dry cloth.', 'Rinse with water.',
            ],
        ...
        'Red Wine': { 
            videoUrl: asset('videos/Red_wine_small720p.mp4'),
...
const basePath = asset('images/fabrics/');
...
function init3D() {
    ...
    loader.load(asset('sofa_pillow.glb'), function (gltf) {
